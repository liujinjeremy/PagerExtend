...
public class EdgeEffectUtil {
      ...
      public boolean isLeftFinished ( ) {
            ...
            return mLeftEffect.isFinished();
      }

      public boolean isTopFinished ( ) {

            return mTopEffect.isFinished();
      }

      public boolean isRightFinished ( ) {

            return mRightEffect.isFinished();
      }

      public boolean isBottomFinished ( ) {

            return mBottomEffect.isFinished();
      }
